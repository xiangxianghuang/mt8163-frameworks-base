...
public class FloatAppAdapter extends BaseAdapter {
    ...
    public FloatAppAdapter(Context context, FloatModel model, int floatContainer) {
        ...
        Log.d(TAG, "FloatAppAdapter construct: floatContainer = "
    ...
    private void bindView(View view, int position) {
        ...
        if (DEBUG) {
            Log.d(TAG, "bindView: position = " + position + ",item.visible = "
        ...
        if (item.visible) {
            ...
            if (DEBUG) {
                Log.d(TAG, "bindView set view invisible: position = "
    ...
    public void addItem(FloatAppItem item, int position) {
        Log.d(TAG, "addItem: position = " + position + ", item = " + item
    ...
    public void reorder(int fromPosition, int toPosition) {
        ...
        Log.d(TAG, "Reorder item: fromPosition = " + fromPosition
    ...
    public Intent intentForPosition(int position) {
        if (mActivitiesList == null || mActivitiesList.size() <= position) {
            Log.d(TAG, "No intent for position(" + position
    ...
    private void updateItemInfoBetween(int fromPosition, int toPosition) {
        Log.d(TAG, "updateItemInfoBetween: fromPosition = " + fromPosition
