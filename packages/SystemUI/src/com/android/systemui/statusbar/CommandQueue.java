...
public class CommandQueue extends IStatusBar.Stub {
    ...
    private final class H extends Handler {
        public void handleMessage(Message msg) {
            ...
            switch (what) {
                ...
                case MSG_SHOW_DEFAULT_ACCOUNT:
                    mCallbacks.showDefaultAccountStatus((Integer)msg.obj);
                    break;
                case MSG_HIDE_DEFAULT_ACCOUNT:
    ...
    /// M: Support [SIM Indicator] @ {
    /**
     * Show default status icon on StatusBar
     * @param subId value of subId or special value for special account.
     */
    public void showDefaultAccountStatus(int subId) {
        synchronized (mList) {
            mHandler.obtainMessage(MSG_SHOW_DEFAULT_ACCOUNT, subId).sendToTarget();
        }
    }

    public void hideDefaultAccountStatus() {
        synchronized (mList) {
            mHandler.obtainMessage(MSG_HIDE_DEFAULT_ACCOUNT, null).sendToTarget();
        }
    }
    /// @ }
