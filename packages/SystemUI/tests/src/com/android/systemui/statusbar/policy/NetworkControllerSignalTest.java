...
public class NetworkControllerSignalTest extends NetworkControllerBaseTest {
    ...
    private final int PHONE_ID_FIR = 0;
    private final int PHONE_ID_SEC = 1;
    /// @}
    ...
    public void testVolteIconImsStateChanged(){
        ...
        expectedIcon = R.drawable.stat_sys_volte1;
        volteIconTest(PHONE_ID_FIR,
                TelephonyManager.DATA_CONNECTED,
                TelephonyManager.NETWORK_TYPE_LTE,
    ...
    // Sim card 2 register to ims.
    public void testVolteIconChangeRegsterSim2(){
        int expectedIcon = R.drawable.stat_sys_volte2;
        volteIconTest(PHONE_ID_SEC,
                TelephonyManager.DATA_CONNECTED,
                TelephonyManager.NETWORK_TYPE_LTE,
                ServiceState.STATE_IN_SERVICE,
                expectedIcon);
    }
    // Sim card 2 unregister to ims.
    public void testVolteIconChangeUnregsterSim2(){
        int expectedIcon = 0;
        volteIconTest(PHONE_ID_SEC,
                TelephonyManager.DATA_CONNECTED,
                TelephonyManager.NETWORK_TYPE_LTE,
    ...
    public void testVolteIconChangedNetChanged(){
        int expectedIcon = R.drawable.stat_sys_volte1;
        volteIconTest(PHONE_ID_FIR,
                TelephonyManager.DATA_CONNECTED,
                TelephonyManager.NETWORK_TYPE_LTE,
                ServiceState.STATE_IN_SERVICE,
        ...
        expectedIcon = R.drawable.stat_sys_volte1;
        updateDataConnectionState(PHONE_ID_FIR, TelephonyManager.DATA_CONNECTED,
                TelephonyManager.NETWORK_TYPE_LTE);
    ...
    // Sim card1 register to ims and changed to sim card2
    public void testVolteIconFromSim1ToSim2(){
       int expectedIcon = R.drawable.stat_sys_volte1;
        volteIconTest(PHONE_ID_FIR,
                TelephonyManager.DATA_CONNECTED,
                TelephonyManager.NETWORK_TYPE_LTE,
        ...
        expectedIcon = R.drawable.stat_sys_volte2;
        volteIconTest(PHONE_ID_SEC,
                TelephonyManager.DATA_CONNECTED,
                TelephonyManager.NETWORK_TYPE_LTE,
                ServiceState.STATE_IN_SERVICE,
