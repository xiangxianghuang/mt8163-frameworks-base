    ...
    private final void processCurBroadcastLocked(BroadcastRecord r,
        ...
        try {
            ...
            if (!ActivityManagerService.IS_USER_BUILD || DEBUG_BROADCAST) {
                Slog.d(TAG, "BDC-Delivering broadcast: " + r.intent
                    + ", queue=" + mQueueName
                    + ", ordered=" + r.ordered
                    + ", app=" + app
                    + ", receiver=" + r.receiver);
        ...
        if (waitForServices && r.curComponent != null && r.queue.mDelayBehindServices
            ...
            if (receiver == null || nextReceiver == null
                ...
                if (mService.mServices.hasBackgroundServices(r.userId)) {
                    ...
                    Slog.i(TAG, "BDC-Delay finish: " + r.curComponent.flattenToShortString());
    ...
    public void backgroundServicesFinishedLocked(int userId) {
        if (mOrderedBroadcasts.size() > 0) {
            ...
            if (br.userId == userId && br.state == BroadcastRecord.WAITING_SERVICES) {
                Slog.i(TAG, "BDC-Resuming delayed broadcast");
                br.curComponent = null;
                br.state = BroadcastRecord.IDLE;
        ...
        synchronized(mService) {
            ...
            while (mParallelBroadcasts.size() > 0) {
                ...
                if (!ActivityManagerService.IS_USER_BUILD || DEBUG_BROADCAST_LIGHT) {
                    Slog.v(TAG_BROADCAST, "Processing parallel broadcast ["
