...
final class WindowState implements WindowManagerPolicy.WindowState {
    ...
    public void computeFrameLw(Rect pf, Rect df, Rect of, Rect cf, Rect vf, Rect dcf, Rect sf,
        ...
        /// M. BMW. [ALPS02049788]. Use pf as mContainingFrame for floating window
    ...
    public boolean isFocusStack() {
        TaskStack stack = getStack();
        // Slog.d(TAG, "[BMW]isFocusStack stack = " + stack);
    ...
    public boolean isFullFloatWindow() {
        ...
        /// M: [ALPS02018327]. Do not update stackbackground winAnimator for starting window
        if (isFloatingWindow() && mAttrs.x == 0 && mAttrs.y == 0
            ...
            if (WindowManagerService.localLOGV) Slog.d(TAG, "[BMW]Full Float Window: " + this);
            return true;
        }
        return false;
    }
