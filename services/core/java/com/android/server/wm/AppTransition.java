...
public class AppTransition implements Dump {
    ...
    */
    ...
    Animation loadAnimationForFloating(WindowManager.LayoutParams lp, int transit, boolean enter,
            int appWidth, int appHeight, int orientation, Rect containingFrame, Rect contentInsets,
            Rect appFrame, boolean isVoiceInteraction) {
        Animation a;
        if (isVoiceInteraction && (transit == TRANSIT_ACTIVITY_OPEN
            ...
            a = createAnimationForFloatingLocked(transit,enter,appWidth,appHeight);
            /* remove for file dependency
            int animAttr = 0;
            switch (transit) {
                case TRANSIT_ACTIVITY_OPEN:
                    a = enter
                        ? AnimationUtils.loadAnimation(mContext,
                            com.mediatek.internal.R.anim.activity_open_enter)
                        : AnimationUtils.loadAnimation(mContext,
                            com.mediatek.internal.R.anim.activity_open_exit);
                    break;
                case TRANSIT_ACTIVITY_CLOSE:
                    a = enter
                        ? AnimationUtils.loadAnimation(mContext,
                            com.mediatek.internal.R.anim.activity_close_enter)
                        : AnimationUtils.loadAnimation(mContext,
                            com.mediatek.internal.R.anim.activity_close_exit);
                    break;
                case TRANSIT_TASK_OPEN:
                    a = enter
                        ? AnimationUtils.loadAnimation(mContext,
                            com.mediatek.internal.R.anim.task_open_enter)
                        : AnimationUtils.loadAnimation(mContext,
                            com.mediatek.internal.R.anim.task_open_exit);
                    break;
                case TRANSIT_TASK_CLOSE:
                    a = enter
                        ? AnimationUtils.loadAnimation(mContext,
                            com.mediatek.internal.R.anim.task_close_enter)
                        : AnimationUtils.loadAnimation(mContext,
                            com.mediatek.internal.R.anim.task_close_exit);
                    break;
                case TRANSIT_TASK_TO_FRONT:
                    a = enter
                        ? AnimationUtils.loadAnimation(mContext,
                ...
                case TRANSIT_WALLPAPER_OPEN:
                    a = enter
                            ? AnimationUtils.loadAnimation(mContext,
                                com.mediatek.internal.R.anim.wallpaper_open_enter)
                            : AnimationUtils.loadAnimation(mContext,
                                com.mediatek.internal.R.anim.wallpaper_open_exit);
                    break;
                case TRANSIT_WALLPAPER_CLOSE:
                    a = enter
                        ? AnimationUtils.loadAnimation(mContext,
                            com.mediatek.internal.R.anim.wallpaper_close_enter)
                        : AnimationUtils.loadAnimation(mContext,
                            com.mediatek.internal.R.anim.wallpaper_close_exit);
                    break;
                case TRANSIT_WALLPAPER_INTRA_OPEN:
                    a = enter
                        ? AnimationUtils.loadAnimation(mContext,
                            com.mediatek.internal.R.anim.wallpaper_intra_open_enter)
                        : AnimationUtils.loadAnimation(mContext,
                            com.mediatek.internal.R.anim.wallpaper_intra_open_exit);
                    break;
                case TRANSIT_WALLPAPER_INTRA_CLOSE:
                    a = enter
                        ? AnimationUtils.loadAnimation(mContext,
                            com.mediatek.internal.R.anim.wallpaper_intra_close_enter)
                        : AnimationUtils.loadAnimation(mContext,
                            com.mediatek.internal.R.anim.wallpaper_intra_close_exit);
                    break;
                default:
                    a = null;
                    break;
    ...
    private Animation createAnimationForFloatingLocked(int transit, boolean enter,
                                                   int appWidth, int appHeight) {
        Animation a = null;
        if (enter) {
            if (transit == TRANSIT_ACTIVITY_OPEN
                    || transit == TRANSIT_WALLPAPER_CLOSE) {
                Animation scale = new ScaleAnimation(0.8f, 1f, 0.8f, 1f,
                        Animation.RELATIVE_TO_SELF, 0.5f,
                        Animation.RELATIVE_TO_SELF, 0.5f);
                scale.setInterpolator(mDecelerateInterpolator);
                Animation alpha = new AlphaAnimation(0, 1);
                alpha.setInterpolator(mDecelerateInterpolator);
                AnimationSet set = new AnimationSet(false);
                set.addAnimation(alpha);
                set.addAnimation(scale);
                a = set;
                ...
                a = alpha;
                a.setDuration(300);
                a.setZAdjustment(Animation.ZORDER_NORMAL);
            } else if (transit == TRANSIT_TASK_OPEN
                           || transit == TRANSIT_TASK_TO_FRONT) {
                Interpolator interpolator = new DecelerateInterpolator(2.5f);
                Animation alpha = new AlphaAnimation(0, 1);
                TranslateYAnimation translateY = new TranslateYAnimation(
                        Animation.ABSOLUTE, 1.2f, Animation.ABSOLUTE, 0f);
                translateY.setInterpolator(interpolator);
                Animation scale = new ScaleAnimation(0.5f, 1f, 0.5f, 1f,
                        Animation.RELATIVE_TO_SELF, 0.5f,
            ...
            if (transit == TRANSIT_ACTIVITY_OPEN) {
                ...
                Animation alpha = new AlphaAnimation(1, 0);
                Animation scale = new ScaleAnimation(1.0f, 0.8f, 1.0f, 0.8f,
                       Animation.RELATIVE_TO_SELF, 0.5f,
                       Animation.RELATIVE_TO_SELF, 0.5f);
                alpha.setInterpolator(mDecelerateInterpolator);
                scale.setInterpolator(mDecelerateInterpolator);
                ...
                Animation alpha = new AlphaAnimation(1, 0);
                TranslateYAnimation translateY = new TranslateYAnimation(
                       Animation.ABSOLUTE, 0f, Animation.ABSOLUTE, -1.2f);
                translateY.setInterpolator(interpolator);
                Animation scale = new ScaleAnimation(1f, 0.5f, 1f, 0.5f,
                       Animation.RELATIVE_TO_SELF, 0.5f,
                       Animation.RELATIVE_TO_SELF, 0f);
                AnimationSet set = new AnimationSet(false);
                set.addAnimation(alpha);
                ...
                a.setDuration(400);
                          ...
                          || transit == TRANSIT_TASK_TO_BACK) {
                Interpolator interpolator = new AccelerateInterpolator(2.5f);
                Animation alpha = new AlphaAnimation(0, 1);
                TranslateYAnimation translateY = new TranslateYAnimation(
                       Animation.ABSOLUTE, 0f, Animation.ABSOLUTE, 1.2f);
                translateY.setInterpolator(interpolator);
                ...
                a.setZAdjustment(Animation.ZORDER_NORMAL);
                a.setDuration(400);
            }else if (transit == TRANSIT_WALLPAPER_OPEN) {
                Animation alpha = new AlphaAnimation(1, 0);
