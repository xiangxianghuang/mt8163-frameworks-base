...
public class DataShapingServiceImpl extends IDataShapingManager.Stub {
    ...
    public void registerReceiver() {
            ...
            mBroadcastReceiver = new BroadcastReceiver() {
                ...
                public void onReceive(Context context, Intent intent) {
                    ...
                    if (Intent.ACTION_SCREEN_ON == action) {
                        ...
                        mDataShapingHandler.obtainMessage
                        (MSG_SHARED_DEFAULT_APN_STATE_CHANGED, intent).sendToTarget();
                    } else if (CLOSE_TIME_EXPIRED_ACTION == action) {
                        getWakeLock();
                        mDataShapingHandler.obtainMessage(MSG_GATE_CLOSE_TIMER_EXPIRED)
                        .sendToTarget();
        ...
        Slog.d(TAG, "addAppIdleStateChangeListener end");
    }
    ...
    public void setDeviceIdleMode(boolean enabled) {
        Slog.d(TAG, "setDeviceIdleMode is " + enabled);
        mDataShapingUtils.setDeviceIdleState(enabled);
        mDataShapingHandler.obtainMessage(MSG_DEVICEIDLE_CHANGED, enabled)
                .sendToTarget();
    }
    /// integrate Doze and App Standby @}
    ...
    private class DataShapingHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            case MSG_BT_AP_STATE_CHANGED:
                ...
                break;
            /// M: integrate Doze and App Standby @{
            case MSG_DEVICEIDLE_CHANGED:
                mCurrentState.onDeviceIdleStateChanged((Boolean)msg.obj);
                break;
            case MSG_APPSTANDBY_CHANGED:
                mCurrentState.onAPPStandbyStateChanged((Boolean)msg.obj);
                break;
            /// integrate Doze and App Standby @}
            default:
                break;
    ...
    private ContentObserver mSettingsObserver = new ContentObserver(new Handler()) {
         public void onChange(boolean selfChange) {
            ...
            if ("0".equals(SystemProperties.get("persist.datashaping.enable", "-1"))) {
                ...
                Slog.d(TAG, "persist.datashaping.enable is false");
            } else if ("1".equals(SystemProperties.get("persist.datashaping.enable", "-1"))) {
                dataShapingEnabled = true;
                Slog.d(TAG, "persist.datashaping.enable is true");
            }
            /// M: AlarmGrouping & DataShaping Testing Config to force Enable or Disable Feature. @}
    ...
    private class AppIdleStateChangeListener
        ...
        public void onParoleStateChanged(boolean isParoleOn) {
            Slog.d(TAG, "onParoleStateChanged is " + isParoleOn);
            mDataShapingHandler.obtainMessage(MSG_APPSTANDBY_CHANGED, isParoleOn)
                    .sendToTarget();
        }
    }
    /// integrate Doze and App Standby @}
