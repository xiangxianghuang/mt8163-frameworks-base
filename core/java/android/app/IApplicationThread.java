...
public interface IApplicationThread extends IInterface {
    ...
    /// M: ALPS00497111 [Volunteer free] GMO Memory Optimized
    int SET_TRIM_MEMORY_FLAG_EX = IBinder.FIRST_CALL_TRANSACTION + 103;

    /// M: ALPS00497111 [Volunteer free] GMO Memory Optimized
    int RESET_SL_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION + 104;

    /// M: MSG HISTORY mechanism for SystemServer @{
    int DUMP_ALL_MESSAGE_HISTORY_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION + 105;
    ///@}
    int SCHEDULE_RESTORE_ACTIVITY_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION + 106;    /// M: BMW
}
